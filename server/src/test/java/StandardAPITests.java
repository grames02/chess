...
public class StandardAPITests {
    ...
    public void clearData() {
        ...
        //log in new user
        TestUser user = new TestUser("ClearMe", "cleared", "clear_all@mail.com");
        ...
        Assertions.assertEquals(0, listResult.getGames().length, "list result did not return 0 games after clear_all");
    }
